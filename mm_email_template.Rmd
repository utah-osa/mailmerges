...
# } else {
  knitr::include_graphics("00aa_total_compliance_header.png")
# }
...
Our records indicate we have not received the required financial reports for **`r params$entity_name`**. This postcard serves as the notice required by *Utah Code, Section 67-3-1(8)*, for the Utah State Auditor to provide intent to withhold state-allocated funds and property tax distributions from delinquent entities. **If these reports are not submitted within 60 days, state allocated funds and property tax distributions will be withheld from your entity at that time.**
...
<p>&nbsp;</p>
For treasurer reports, contact Ann Pedroza -  apedroza@utah.gov | 801-538-1883
